...
router.post('/', (req, res) => {
    var data = "SELECT a.*, b.namaLengkap, b.status, c.namaPenguji from jadwal as a join c_mhs as b on a.idMahasiswa=b.idMahasiswa join penguji as c on a.idPenguji=c.idPenguji order by b.status asc"
